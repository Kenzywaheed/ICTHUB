...
//   const roadmapData = {
//     technology: [
//       { img: "/csm.jpeg", text: "Some quick example text to build on the card title and make up the bulk of the card's content." },
//       { img: "/csm.jpeg", text: "Some quick example text to build on the card title and make up the bulk of the card's content." },
//       { img: "/csm.jpeg", text: "Some quick example text to build on the card title and make up the bulk of the card's content." },
//     ],
//     construction: [
...
//           <Card.Img className="service-card-img" variant="top" src={card.img} />
//           <Card.Body className="service-card-body">
//             <Card.Text className="service-card-text">{card.text}</Card.Text>
//           </Card.Body>
//         </Card>
//       ))}
//     </div>
...
//         >
//           <Tab eventKey="frontend" title="Technology">
//             {renderCards(roadmapData.frontend)}
//           </Tab>

//           <Tab eventKey="backend" title="Construction">
//             {renderCards(roadmapData.backend)}
//           </Tab>

//           <Tab eventKey="mobile" title="Finishing">
//             {renderCards(roadmapData.mobile)}
//           </Tab>

//            <Tab eventKey="mobile" title="Training">
//             {renderCards(roadmapData.mobile)}
//           </Tab>
//         </Tabs>
//       </div>
